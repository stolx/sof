...
PIPELINE_PCM_ADD(
	ifelse(WAVES, `1', sof/pipe-waves-codec-demux-playback.m4, sof/pipe-volume-demux-playback.m4),
	1, 0, 2, s32le,
	1000, 0, 0,
	48000, 48000, 48000)
...
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(
	ifelse(WAVES, `1', sof/pipe-waves-codec-playback.m4, sof/pipe-volume-playback.m4),
	2, 1, 2, s32le,
	1000, 0, 0,
	48000, 48000, 48000)
