...
C_CONTROLBYTES(MaxxEffect Dummy Setup, PIPELINE_ID,
...
C_CONTROLBYTES(MaxxEffect Dummy Runtime, PIPELINE_ID,
        CONTROLBYTES_OPS(bytes),
        CONTROLBYTES_EXTOPS(void, 258, 258),
        , , ,
        CONTROLBYTES_MAX(void, 300),
...
W_CODEC_ADAPTER(0, PIPELINE_FORMAT, DAI_PERIODS, DAI_PERIODS, PP_CORE,
        LIST(`          ', "MaxxEffect Dummy Setup", "MaxxEffect Dummy Runtime"))
